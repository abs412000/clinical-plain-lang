...
cli.py
------
Command-line interface for clinical-plain-lang.

Usage:
    python cli.py --file myreport.txt --audience patient
    python cli.py --file myreport.txt --all-audiences
    python cli.py --file myreport.txt --audience public --output result.json
    cat myreport.txt | python cli.py --stdin --audience caregiver
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert clinical/medical documents into plain language summaries.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python cli.py --file report.txt --audience patient
  python cli.py --file report.txt --all-audiences --output results.json
  cat report.txt | python cli.py --stdin --audience public
        """
    )
